...
class ServiceController extends Controller
{
    ...
    $service = $request->services_id ; */
        ...
        $service = DB::table('services')->select('services.*', 'images.image_url', 'users.name', 'users.profile_photo_path', 'tags.tag_name', 'categories.type', 'prices.currency', 'prices.price')->join('categories', 'categories.id', 'services.categories_id')->join('images', 'images.id', 'services.images_id')->join('users', 'users.id', 'services.users_id')->join('tags', 'tags.id', 'services.tags_id')->join('prices', 'prices.id', 'services.price_id')->get();
        return $service;
